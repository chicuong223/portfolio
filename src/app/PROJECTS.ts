...
export const PROJECTS: Project[] = [
    {
        name: 'Portfolio',
        projectTime: 'Aug 2024',
        description: 'A portfolio website to showcase my skills and work experiences.',
        documentUrl: '',
        repositoryUrl: 'https://github.com/chicuong223/portfolio',
        responsibilities: [],
        techStack: [
            'Angular 18',
            'Bootstrap 5',
        ...
        appWebsite: 'https://chicuong-portfolio.azurewebsites.net/'
    },
    {
